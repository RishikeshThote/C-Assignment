...
namespace CoadBasedTes3
{
    class Program
    {
        ...
        {
            con = new SqlConnection(@"data source = POOLW42SLPC6857\SQLEXPRESS; Initial Catalog = EmployeeManagement; user id =sa; password =Temp1234");
            con.Open();
            return con;
        }
        ...
        public static void insertEmployee()
        {
            ...
            {
                con = getconnection();
                Console.WriteLine("Enter the nameof Employee  : ");
